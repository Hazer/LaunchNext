...
struct GestureConfiguration: Equatable {
    ...
    var stableContactDuration: TimeInterval = 0.015
    var openTriggerScaleRatio: Double = 0.84
    var closeTriggerScaleRatio: Double = 1.10
    var openPerFingerRadiusRatio: Double = 0.96
    var closeLeadingFingerRadiusRatio: Double = 1.04
    var minimumOpenParticipatingFingerCount: Int = 3
    var minimumCloseLeadingGap: Double = 0.02
    var maximumCloseSupportingSpread: Double = 0.30
    var requiredConsecutiveMatches: Int = 1
